...
export default function Projects() {
  ...
  const projects = [
    ...
    // 2. BHS (BestMed) Healthcare Platform
    {
      ...
      tech: ['C# .NET Core', 'PostgreSQL', 'Redis', 'RabbitMQ', 'Emergency Admin', 'BestmedIQ AI', 'Angular', 'Docker'],
      icon: Activity,
      color: '#06b6d4',
      ...
      badgeText: '#6ee7b7',
      metrics: [
        { label: 'Daily Claims', value: '10,000+' },
        { label: 'Query Latency', value: '-70%' },
        { label: 'Emergency SLA', value: '< 2s' },
      ],
      highlights: [
        t('proj_bhs_h1'),
        t('proj_bhs_h2'),
