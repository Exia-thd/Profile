...
export const translations = {
  en: {
    ...
    about_hl1_desc: '5+ years developing robust backend systems with Java Spring Boot, C# .NET, Python and Node.js',
  ...
  vi: {
    ...
    about_hl1_title: 'Backend Excellence',
    about_hl1_desc: 'Hơn 5 năm phát triển hệ thống với Java Spring Boot, C# .NET, Python và Node.js',
    about_hl2_title: 'Cloud & Serverless (AWS)',
    about_hl2_desc: 'AWS Lambda, API Gateway, Cognito, SQS, S3, Aurora PostgreSQL, CloudWatch, CloudFormation/SAM',
